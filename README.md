# Awesome Electronics [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) with stars
...
This list is for websites, services, software, tools and more: everything that you think is awesome in the world of Electronic Engineering. If you have anything to add please follow the instructions in [contributing.md](origin/contributing.md).
...
* [Inkscape Electric Symbols](https://github.com/upb-lea/Inkscape_electric_Symbols) ⭐ 504 | 🐛 4 | 📅 2025-12-08 - Circuit Drawing Symbols for Inkscape
...
* [GeckoCIRCUITS](https://de.wikipedia.org/wiki/GeckoCircuits) - Open Source Power Electronic Circuit Simulator. [GitHub Project](https://github.com/geckocircuits/GeckoCIRCUITS) ⭐ 76 | 🐛 11 | 🌐 Java | 📅 2024-07-15. Direct [download link](http://gecko-simulations.com/GeckoCIRCUITS/GeckoCIRCUITS.zip) due to broken website.
...
* [Horizon EDA](https://github.com/horizon-eda/horizon) ⭐ 1,252 | 🐛 162 | 🌐 C | 📅 2026-02-03 - A free and open source EDA tool with the focus on shortcut operation.
...
* [Keyboard PCB Guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,793 | 🐛 22 | 📅 2024-07-02 -  Comprehensive written tutorial that takes you through creating a keyboard PCB.
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,291 | 🐛 43 | 🌐 Python | 📅 2026-01-11 - A html BOM generation tool for manual pick and place.
* [Xesscorp's list of KiCad 3rd party tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 803 | 🐛 1 | 📅 2025-11-20
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 685 | 🐛 24 | 🌐 Python | 📅 2026-02-06 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
* [Footprint Collection](https://github.com/kitspace/kicad_footprints) ⭐ 353 | 🐛 4 | 🌐 Python | 📅 2023-01-25 - Collection of all the KiCad footprints available online and some scripts to manage them.
...
* [SparkFun Electronics Eagle Libraries](https://github.com/sparkfun/SparkFun-Eagle-Libraries) ⭐ 1,789 | 🐛 10 | 📅 2024-08-23
...
* [Part-DB](https://github.com/Part-DB/Part-DB) ⭐ 163 | 🐛 36 | 🌐 JavaScript | 📅 2024-04-15 - Another open source web service for managing part inventory with a permission system and a good barcode generator.
...
* [Language PCB](https://github.com/Alhadis/language-pcb) ⭐ 20 | 🐛 0 | 📅 2022-02-10 - Syntax highlighting for various PCB formats.
...
* [embedded-boston/awesome-embedded-systems](https://github.com/embedded-boston/awesome-embedded-systems) ⭐ 944 | 🐛 5 | 📅 2024-01-04 - Awesome list of embedded programming resources.
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 693 | 🐛 0 | 📅 2024-01-17 - Helpful items for making and learning about open source hardware projects.
* [intajay/open-electronics](https://github.com/intajay/open-electronics) ⭐ 677 | 🐛 0 | 📅 2024-12-22 - Another GitHub list: resources for Electronics Enthusiasts and Hardware Hackers.
* [cajt/list\_of\_robot\_electronics](https://github.com/cajt/list_of_robot_electronics) ⭐ 414 | 🐛 1 | 📅 2025-07-26 - A GitHub list of resources, projects and products for robot electronics.
* [PwnKitteh/InsanelyCheapElectronics](https://github.com/PwnKitteh/InsanelyCheapElectronics) ⭐ 386 | 🐛 1 | 📅 2021-03-29 - A list of cheap electronics from China, that you can use in your projects.
* [Vitorian/awesome-fpga](https://github.com/Vitorian/awesome-fpga) ⭐ 381 | 🐛 0 | 📅 2017-05-25 - Awesome list of FPGA resources.
...
* [upb-lea/awesome-open-source-power-electronics](https://github.com/upb-lea/awesome-open-source-power-electronics) ⭐ 293 | 🐛 0 | 📅 2025-03-11 - Open source software list specialized on power electronics.
