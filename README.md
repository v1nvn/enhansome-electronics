...
* [Horizon EDA](https://github.com/horizon-eda/horizon) ⭐ 1,275 | 🐛 163 | 🌐 C | 📅 2026-03-15 - A free and open source EDA tool with the focus on shortcut operation.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,335 | 🐛 44 | 🌐 Python | 📅 2026-03-14 - A html BOM generation tool for manual pick and place.
* [Xesscorp's list of KiCad 3rd party tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 813 | 🐛 1 | 📅 2025-11-20
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 695 | 🐛 23 | 🌐 Python | 📅 2026-03-20 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
...
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 716 | 🐛 1 | 📅 2026-03-10 - Helpful items for making and learning about open source hardware projects.
