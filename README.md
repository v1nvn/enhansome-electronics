...
* [Inkscape Electric Symbols](https://github.com/upb-lea/Inkscape_electric_Symbols) ⭐ 535 | 🐛 3 | 📅 2026-02-08 - Circuit Drawing Symbols for Inkscape
...
* [GeckoCIRCUITS](https://de.wikipedia.org/wiki/GeckoCircuits) - Open Source Power Electronic Circuit Simulator. [GitHub Project](https://github.com/geckocircuits/GeckoCIRCUITS) ⭐ 81 | 🐛 9 | 🌐 Java | 📅 2026-02-23. Direct [download link](http://gecko-simulations.com/GeckoCIRCUITS/GeckoCIRCUITS.zip) due to broken website.
...
* [Horizon EDA](https://github.com/horizon-eda/horizon) ⭐ 1,294 | 🐛 162 | 🌐 C | 📅 2026-03-27 - A free and open source EDA tool with the focus on shortcut operation.
...
* [Keyboard PCB Guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,889 | 🐛 22 | 📅 2024-07-02 -  Comprehensive written tutorial that takes you through creating a keyboard PCB.
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,394 | 🐛 38 | 🌐 Python | 📅 2026-04-23 - A html BOM generation tool for manual pick and place.
* [Xesscorp's list of KiCad 3rd party tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 820 | 🐛 1 | 📅 2026-05-15
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 713 | 🐛 26 | 🌐 Python | 📅 2026-05-22 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
* [Footprint Collection](https://github.com/kitspace/kicad_footprints) ⭐ 361 | 🐛 4 | 🌐 Python | 📅 2023-01-25 - Collection of all the KiCad footprints available online and some scripts to manage them.
...
* [SparkFun Electronics Eagle Libraries](https://github.com/sparkfun/SparkFun-Eagle-Libraries) ⭐ 1,795 | 🐛 10 | 📅 2024-08-23
...
* [Part-DB](https://github.com/Part-DB/Part-DB) ⭐ 164 | 🐛 36 | 🌐 JavaScript | 📅 2024-04-15 - Another open source web service for managing part inventory with a permission system and a good barcode generator.
...
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 818 | 🐛 4 | 📅 2026-04-20 - Helpful items for making and learning about open source hardware projects.
...
* [cajt/list\_of\_robot\_electronics](https://github.com/cajt/list_of_robot_electronics) ⭐ 427 | 🐛 1 | 📅 2025-07-26 - A GitHub list of resources, projects and products for robot electronics.
...
* [upb-lea/awesome-open-source-power-electronics](https://github.com/upb-lea/awesome-open-source-power-electronics) ⭐ 318 | 🐛 0 | 📅 2026-03-10 - Open source software list specialized on power electronics.
