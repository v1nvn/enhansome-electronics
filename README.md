...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,334 | 🐛 44 | 🌐 Python | 📅 2026-03-14 - A html BOM generation tool for manual pick and place.
* [Xesscorp's list of KiCad 3rd party tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 813 | 🐛 1 | 📅 2025-11-20
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 694 | 🐛 23 | 🌐 Python | 📅 2026-03-20 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
