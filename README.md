...
* [Inkscape Electric Symbols](https://github.com/upb-lea/Inkscape_electric_Symbols) ⭐ 540 | 🐛 3 | 📅 2026-02-08 - Circuit Drawing Symbols for Inkscape
...
* [Horizon EDA](https://github.com/horizon-eda/horizon) ⭐ 1,295 | 🐛 162 | 🌐 C | 📅 2026-03-27 - A free and open source EDA tool with the focus on shortcut operation.
...
* [Keyboard PCB Guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,897 | 🐛 22 | 📅 2024-07-02 -  Comprehensive written tutorial that takes you through creating a keyboard PCB.
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,419 | 🐛 38 | 🌐 Python | 📅 2026-05-24 - A html BOM generation tool for manual pick and place.
* [Xesscorp's list of KiCad 3rd party tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 822 | 🐛 1 | 📅 2026-05-15
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 720 | 🐛 28 | 🌐 Python | 📅 2026-06-09 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
* [Footprint Collection](https://github.com/kitspace/kicad_footprints) ⭐ 362 | 🐛 4 | 🌐 Python | 📅 2023-01-25 - Collection of all the KiCad footprints available online and some scripts to manage them.
...
* [SparkFun Electronics Eagle Libraries](https://github.com/sparkfun/SparkFun-Eagle-Libraries) ⭐ 1,794 | 🐛 10 | 📅 2024-08-23
...
* [Part-DB](https://github.com/Part-DB/Part-DB) ⭐ 165 | 🐛 36 | 🌐 JavaScript | 📅 2024-04-15 - Another open source web service for managing part inventory with a permission system and a good barcode generator.
...
* [embedded-boston/awesome-embedded-systems](https://github.com/embedded-boston/awesome-embedded-systems) ⭐ 981 | 🐛 7 | 📅 2024-01-04 - Awesome list of embedded programming resources.
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 838 | 🐛 1 | 📅 2026-05-27 - Helpful items for making and learning about open source hardware projects.
* [intajay/open-electronics](https://github.com/intajay/open-electronics) ⭐ 723 | 🐛 1 | 📅 2024-12-22 - Another GitHub list: resources for Electronics Enthusiasts and Hardware Hackers.
* [cajt/list\_of\_robot\_electronics](https://github.com/cajt/list_of_robot_electronics) ⭐ 429 | 🐛 1 | 📅 2025-07-26 - A GitHub list of resources, projects and products for robot electronics.
...
* [Vitorian/awesome-fpga](https://github.com/Vitorian/awesome-fpga) ⭐ 391 | 🐛 0 | 📅 2017-05-25 - Awesome list of FPGA resources.
* [Awesome Lattice FPGAs](https://github.com/kelu124/awesome-latticeFPGAs) ⭐ 354 | 🐛 0 | 📅 2026-04-08 - A curated list of awesome open-source FPGA boards.
* [upb-lea/awesome-open-source-power-electronics](https://github.com/upb-lea/awesome-open-source-power-electronics) ⭐ 329 | 🐛 0 | 📅 2026-03-10 - Open source software list specialized on power electronics.
