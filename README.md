...
* [Horizon EDA](https://github.com/horizon-eda/horizon) ⭐ 1,268 | 🐛 162 | 🌐 C | 📅 2026-02-21 - A free and open source EDA tool with the focus on shortcut operation.
...
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,326 | 🐛 43 | 🌐 Python | 📅 2026-03-14 - A html BOM generation tool for manual pick and place.
...
* [embedded-boston/awesome-embedded-systems](https://github.com/embedded-boston/awesome-embedded-systems) ⭐ 948 | 🐛 6 | 📅 2024-01-04 - Awesome list of embedded programming resources.
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 713 | 🐛 0 | 📅 2026-03-10 - Helpful items for making and learning about open source hardware projects.
...
* [upb-lea/awesome-open-source-power-electronics](https://github.com/upb-lea/awesome-open-source-power-electronics) ⭐ 301 | 🐛 0 | 📅 2026-03-10 - Open source software list specialized on power electronics.
