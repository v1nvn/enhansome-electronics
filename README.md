...
* [Inkscape Electric Symbols](https://github.com/upb-lea/Inkscape_electric_Symbols) ⭐ 536 | 🐛 3 | 📅 2026-02-08 - Circuit Drawing Symbols for Inkscape
...
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 716 | 🐛 26 | 🌐 Python | 📅 2026-06-02 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
...
* [embedded-boston/awesome-embedded-systems](https://github.com/embedded-boston/awesome-embedded-systems) ⭐ 976 | 🐛 7 | 📅 2024-01-04 - Awesome list of embedded programming resources.
...
* [intajay/open-electronics](https://github.com/intajay/open-electronics) ⭐ 720 | 🐛 1 | 📅 2024-12-22 - Another GitHub list: resources for Electronics Enthusiasts and Hardware Hackers.
...
* [upb-lea/awesome-open-source-power-electronics](https://github.com/upb-lea/awesome-open-source-power-electronics) ⭐ 322 | 🐛 0 | 📅 2026-03-10 - Open source software list specialized on power electronics.
