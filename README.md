...
* [Keyboard PCB Guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,881 | 🐛 22 | 📅 2024-07-02 -  Comprehensive written tutorial that takes you through creating a keyboard PCB.
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,387 | 🐛 38 | 🌐 Python | 📅 2026-04-23 - A html BOM generation tool for manual pick and place.
* [Xesscorp's list of KiCad 3rd party tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 818 | 🐛 1 | 📅 2026-05-10
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 712 | 🐛 27 | 🌐 Python | 📅 2026-05-12 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
