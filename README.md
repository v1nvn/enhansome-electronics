...
* [Inkscape Electric Symbols](https://github.com/upb-lea/Inkscape_electric_Symbols) ⭐ 530 | 🐛 3 | 📅 2026-02-08 - Circuit Drawing Symbols for Inkscape
...
* [Keyboard PCB Guide](https://github.com/ruiqimao/keyboard-pcb-guide) ⭐ 4,869 | 🐛 22 | 📅 2024-07-02 -  Comprehensive written tutorial that takes you through creating a keyboard PCB.
* [InteractiveHtmlBom](https://github.com/openscopeproject/InteractiveHtmlBom) ⭐ 4,380 | 🐛 38 | 🌐 Python | 📅 2026-04-23 - A html BOM generation tool for manual pick and place.
* [Xesscorp's list of KiCad 3rd party tools](https://github.com/xesscorp/kicad-3rd-party-tools) ⭐ 818 | 🐛 2 | 📅 2025-11-20
* [KiBot](https://github.com/INTI-CMNB/KiBot) ⭐ 712 | 🐛 28 | 🌐 Python | 📅 2026-05-06 - Generate the fabrication and documentation files for your KiCad projects easily, repeatable, and most of all, scriptably.
...
* [embedded-boston/awesome-embedded-systems](https://github.com/embedded-boston/awesome-embedded-systems) ⭐ 973 | 🐛 7 | 📅 2024-01-04 - Awesome list of embedded programming resources.
* [delftopenhardware/awesome-open-hardware](https://github.com/delftopenhardware/awesome-open-hardware) ⭐ 812 | 🐛 4 | 📅 2026-04-20 - Helpful items for making and learning about open source hardware projects.
* [intajay/open-electronics](https://github.com/intajay/open-electronics) ⭐ 713 | 🐛 1 | 📅 2024-12-22 - Another GitHub list: resources for Electronics Enthusiasts and Hardware Hackers.
...
* [upb-lea/awesome-open-source-power-electronics](https://github.com/upb-lea/awesome-open-source-power-electronics) ⭐ 315 | 🐛 0 | 📅 2026-03-10 - Open source software list specialized on power electronics.
